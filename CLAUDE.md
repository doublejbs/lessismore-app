...
- **Git 브랜치 정책 (2026-07-05부터)**: 작업은 `main` 베이스 — 작업 브랜치를 `main`에서 따고 PR 베이스도 `main`으로 보낸다. `main`에 직접 커밋하지 않는다 (항상 PR 경유). `develop` 기반 정책(2026-06-11~07-05)은 폐기 — `develop` 브랜치는 더 이상 쓰지 않는다
