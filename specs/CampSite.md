...
- 상세 헤더 우측에 **공유 아이콘 버튼**(지도 열기 버튼 왼쪽). 탭 → OS 공유 시트(`Share.share`)로 URL `https://useless.my/camp-share/{spotId}`**만** 내보낸다(이름 등 텍스트를 붙이면 '복사' 시 URL이 아닌 문자열이 복사돼 링크로 동작하지 않음).
